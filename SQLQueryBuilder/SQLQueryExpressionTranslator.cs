...
namespace SQLQueryBuilder
{
    ...
    internal class SQLQueryExpressionTranslator : ExpressionVisitor, ISQLQueryExpressionTranslator
    {
        ...
        protected override Expression VisitMethodCall(MethodCallExpression node)
        {
            ...
            else if (declaringType == typeof(Row) || declaringType == typeof(RowNumber))
            {
        ...
        private Expression VisitRowMethodCall(MethodCallExpression node)
        {
            ...
            else if (node.Method.Name == nameof(RowNumber.Over))
            {
                Visit(node.Arguments[0]);
        ...
        {
            if (node.Method.Name == nameof(SQLQueryConversionExtensions.Decompress))
            {
