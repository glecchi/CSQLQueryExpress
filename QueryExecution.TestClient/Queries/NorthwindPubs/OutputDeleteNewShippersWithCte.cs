...
{
    [SQLQueryCommand(4)]
    internal class OutputDeleteNewShippersWithCte : SQLOutputQueryCommand<dbo.Shippers>
    {
        public OutputDeleteNewShippersWithCte(ISQLQueryCommandFactory commandFactory)
            : base(commandFactory)
        {
        }
